    ...
    public class ApplicationDbContext : IdentityDbContext<Usuario>
    {
        ...
        private void SeedData(ModelBuilder builder)
        {
            ...
            builder.Entity<Producto>().HasData(
                new Producto { Id = 1, Nombre = "Base Líquida FIT ME", Descripcion = "Base de maquillaje líquida con cobertura natural", Precio = 45.99m, Stock = 50, CategoriaId = 1, MarcaId = 1, Codigo = "MAY001" },
                new Producto { Id = 2, Nombre = "Máscara de Pestañas Voluminous", Descripcion = "Máscara que proporciona volumen y longitud", Precio = 32.50m, Stock = 30, CategoriaId = 1, MarcaId = 2, Codigo = "LOR001" },
                new Producto { Id = 3, Nombre = "Crema Hidratante Facial", Descripcion = "Crema hidratante para todo tipo de piel", Precio = 28.75m, Stock = 40, CategoriaId = 2, MarcaId = 4, Codigo = "NEU001" },
                new Producto { Id = 4, Nombre = "Jabón Corporal Nutritivo", Descripcion = "Jabón corporal con 1/4 de crema hidratante", Precio = 15.99m, Stock = 60, CategoriaId = 3, MarcaId = 5, Codigo = "DOV001" },
                new Producto { Id = 5, Nombre = "Labial Mate ColorStay", Descripcion = "Labial de larga duración con acabado mate", Precio = 22.30m, Stock = 35, CategoriaId = 1, MarcaId = 3, Codigo = "REV001" }
            );
        }
    }
} 